...
class ClothingItem {
    ...
    lateinit var slot: ClothingSlot
    ...
    fun serialize(): ClothingItemSerial {
        if (this.isInitialized)
        {
            return ClothingItemSerial(
                name, slot.slotName, tags, description, id+":"+variant,
        ...
        return ClothingItem("PLACEHOLDER").serialize() // FIXME: this could cause a loop. not good.
    }
    companion object {
